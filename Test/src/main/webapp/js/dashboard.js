    ...
    filteredProducts.forEach(product => {
        ...
        card.innerHTML = `
            ...
            <div class="product-image-container">
                <img class="product-img" src="${product.image || 'https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?auto=format&fit=crop&q=80&w=300'}" alt="${product.itemName || 'Product'}">
            </div>
...
function renderCart() {
    ...
    cart.forEach(item => {
        ...
        cartItemRow.innerHTML = `
            <img src="${item.image || 'https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?auto=format&fit=crop&q=80&w=300'}" alt="${item.itemName}" class="cart-item-img">
...
async function closeReceiptModal() {
    ...
    if (pendingCheckoutOrder) {
        ...
        await saveOrderHistoryEntry(pendingCheckoutOrder);
